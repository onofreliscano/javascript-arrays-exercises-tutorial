...
waldoName = "Waldo";
console.log (waldoName.toUpperCase());
console.log (waldoName.toLowerCase());

for(var i = 0; i<=people.length; i = i + 1) {

    if (people[i] == waldoName.toUpperCase() || people[i] == waldoName.toLowerCase() || people[i] == waldoName) {
        console.log("I found " + people[i] + " in position: " + i );
    }
